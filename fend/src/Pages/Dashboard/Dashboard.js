...
//     const cards = [
//         { title: 'Total Event Listed', text: totalEvents.totalevent, color: 'linear-gradient(135deg, #8A2BE2, #BA55D3)', icon: <AppstoreOutlined style={{ color: '#fff', fontSize: '60px' }} /> },
//         { title: 'Events in Queue', text: inprogress.inprogressEvent, color: 'linear-gradient(135deg, #8A2BE2, #BA55D3)', icon: <HomeOutlined style={{ color: '#fff', fontSize: '60px' }} /> },
//         { title: 'Events Completed', text: completedEvent.completedEvent, color: 'linear-gradient(135deg, #8A2BE2, #BA55D3)', icon: <AppstoreOutlined style={{ color: '#fff', fontSize: '60px' }} /> },
//         { title: 'New Events....', text: weekEvent.weekEvent, color: 'linear-gradient(135deg, #8A2BE2, #BA55D3)',icon: <HomeOutlined style={{ color: '#fff', fontSize: '60px' }} /> }
//     ];
